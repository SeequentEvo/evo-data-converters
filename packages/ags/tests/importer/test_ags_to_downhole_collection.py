...
def test_create_dc_basic_with_tags(mock_ags_context):
...
def test_create_dc_collars_structure(mock_ags_context):
...
def test_create_dc_collars_final_depths(mock_ags_context):
...
def test_create_dc_collars_coordinates(mock_ags_context):
...
def test_create_dc_collars_scpg_merge(mock_ags_context):
...
def test_create_dc_measurements_hole_index(mock_ags_context):
...
def test_create_dc_collars_column_ordering(mock_ags_context):
...
def test_create_dc_measurements_depth_columns(mock_ags_context):
    ...
    assert len(found_depth_columns) > 0, f"Expected depth columns from measurement groups, found: {found_depth_columns}"


def test_create_dc_measurements_count(mock_ags_context):
...
def test_create_dc_measurements_scpt_data(mock_ags_context):
...
def test_create_dc_measurements_scpp_data(mock_ags_context):
...
def test_create_dc_measurements_geol_data(mock_ags_context):
...
def test_create_dc_measurements_scdg_data(mock_ags_context):
...
def test_create_dc_measurements_scpt_empty_table(mock_ags_context):
