...
from evo.data_converters.common.objects.attributes import (
    ...
    CONTINUOUS_CONFIG,
    DATETIME_CONFIG,
    PD_INFERRED_TYPE_MAP,
    INTEGER_CONFIG,
    STRING_CONFIG,
    AttributeType,
    attribute_from_pd_series,
    category_attribute_from_pd_series,
    table_from_pd_series,
)
...
class TestPyArrowTableFactory:
    ...
    def test_create_continuous_table(self) -> None:
        ...
        table = table_from_pd_series(series, AttributeType.CONTINUOUS)
    ...
    def test_create_string_table(self) -> None:
        ...
        table = table_from_pd_series(series, AttributeType.STRING)
...
class TestAttributeCreation:
    ...
    def test_create_continuous_attribute(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("resistance", series, mock_data_client)
    ...
    def test_create_continuous_attribute_with_nan_values(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("pressure", series, mock_data_client)
    ...
    def test_create_continuous_from_mixed_integer_float(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("values", series, mock_data_client)
    ...
    def test_create_string_attribute(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("engineer", series, mock_data_client)
    ...
    def test_create_string_attribute_unicode(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("notes", series, mock_data_client)
    ...
    def test_create_integer_attribute(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("count", series, mock_data_client)
    ...
    def test_create_datetime_attribute_from_date(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("date", series, mock_data_client)
    ...
    def test_create_datetime_attribute_from_datetime(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("datetime", series, mock_data_client)
    ...
    def test_create_bool_attribute(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("signed_off", series, mock_data_client)
    ...
    def test_category_attribute_from_pd_series(self, mock_data_client) -> None:
        """Test creating a CategoryAttribute from categorical data."""
        series = pd.Series(["rock", "sand", "clay", "rock", "limestone"], dtype="category")

        attribute = attribute_from_pd_series("lithology", series, mock_data_client)
    ...
    def test_create_integer_pint_degrees(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("angle", series, mock_data_client)
    ...
    def test_create_pint_au(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("distance", series, mock_data_client)
    ...
    def test_create_unsupported_type_returns_none(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("unsupported", series, mock_data_client)
    ...
    def test_create_mixed_type_returns_none(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("mixed", series, mock_data_client)
    ...
    def test_data_client_save_table_called_with_correct_args(self, mock_data_client) -> None:
        ...
        attribute_from_pd_series("floats", series, mock_data_client)
...
class TestCategoricalAttributeCreation:
    """Test category_attribute_from_pd_series()."""

    def test_category_attribute_from_pd_series_basic(self, mock_data_client) -> None:
        series = pd.Series(["sand", "clay", "sand", "rock", "clay"], dtype="category")

        attribute = category_attribute_from_pd_series("lithology", series, mock_data_client)
    ...
    def test_category_attribute_from_pd_series_with_nulls(self, mock_data_client) -> None:
    ...
    def test_create_categorical_saves_lookup_table(self, mock_data_client) -> None:
        ...
        _ = category_attribute_from_pd_series("code", series, mock_data_client)
    ...
    def test_category_attribute_from_pd_series_codes_mapping(self, mock_data_client) -> None:
        series = pd.Series(["sand", "clay", "sand", "rock", "clay"], dtype="category")

        _ = category_attribute_from_pd_series("lithology", series, mock_data_client)
    ...
    def test_create_categorical_empty_series(self, mock_data_client) -> None:
        ...
        # Use attribute_from_pd_series() which checks for empty series and returns None
        attribute = attribute_from_pd_series("empty_cat", series, mock_data_client)
    ...
    def test_create_defers_to_categorical_attribute(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("category_test", series, mock_data_client)
...
class TestInferredTypeMapping:
    ...
    def test_boolean_type_is_mapped(self) -> None:
        config = PD_INFERRED_TYPE_MAP.get("boolean")

        assert config is BOOL_CONFIG

    def test_continuous_types_are_mapped(self) -> None:
        configs = [
            PD_INFERRED_TYPE_MAP.get("floating"),
            PD_INFERRED_TYPE_MAP.get("mixed-integer-float"),
            PD_INFERRED_TYPE_MAP.get("decimal"),
        ]

        assert all(c is CONTINUOUS_CONFIG for c in configs)

    def test_integer_type_is_mapped(self) -> None:
        config = PD_INFERRED_TYPE_MAP.get("integer")

        assert config is INTEGER_CONFIG

    def test_string_types_are_mapped(self) -> None:
        configs = [
            PD_INFERRED_TYPE_MAP.get("string"),
            PD_INFERRED_TYPE_MAP.get("unicode"),
            PD_INFERRED_TYPE_MAP.get("bytes"),
        ]
    ...
    def test_datetime_types_are_mapped(self) -> None:
        configs = [
            PD_INFERRED_TYPE_MAP.get("datetime64"),
            PD_INFERRED_TYPE_MAP.get("datetime"),
            PD_INFERRED_TYPE_MAP.get("date"),
        ]
...
class TestEdgeCases:
    ...
    def test_empty_series(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("empty", series, mock_data_client)
    ...
    def test_all_null_values(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("all_nulls", series, mock_data_client)
    ...
    def test_nan_values_attr_non_list(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("test", series, mock_data_client)
    ...
    def test_categorical_single_category(self, mock_data_client) -> None:
        ...
        attribute = attribute_from_pd_series("single_category", series, mock_data_client)
