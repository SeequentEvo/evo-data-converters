...
def test_polyface_obj_attrs(pit_mesh_attrs, data_client):
    ...
    triangle_mesh_go = convert_duf_polyface(polyface, data_client, crs_from_epsg_code(4326))
...
def test_combine_polyface_attrs(simple_objects_with_attrs, data_client):
    ...
    triangle_mesh_go = combine_duf_polyfaces(polyface_objs, data_client, crs_from_epsg_code(4326))
    attrs = triangle_mesh_go.parts.attributes
