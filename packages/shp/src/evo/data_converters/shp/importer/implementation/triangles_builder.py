...
class TrianglesBuilder:
    ...
    def build(self) -> Triangles_V1_2_0:
        ...
        indices = Triangles_V1_2_0_Indices(attributes=None, data=triangle_hash, length=len(self.triangles), data_type="uint64")
        ...
        if has_vertex_data:
            ...
            vertex_attributes = [ContinuousAttribute_V1_1_0(name="Measurements", key=vertex_data_hash, attribute_description=None, nan_description=vertex_nan_continuous, values=vertex_array)]
        
        vertices = Triangles_V1_2_0_Vertices(attributes=vertex_attributes, data=vertex_hash, length=len(self.vertices), data_type="float64")
