...
uv run "%~dp0publish_to_evo.py" 2>&1 | "%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -Command "$input | ForEach-Object { Write-Output $_; Add-Content -Path '%LOG_FILE%' -Value $_ }"
