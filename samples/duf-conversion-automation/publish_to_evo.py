...
def main():
    ...
    # Determine DUF file path (use argument if provided, otherwise fall back to .env)
    duf_file = args.duf_file or os.getenv('DUF_FILE_PATH')
    
    if not duf_file:
        print("Error: DUF file path is required")
        print("Please provide a DUF file using either:")
        print("  1. The --duf-file argument, or")
        print("  2. Set DUF_FILE_PATH in your .env file")
        sys.exit(1)
